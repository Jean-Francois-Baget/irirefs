	...
	private static List<IReader> readers() {
		return List.of(
			...
			new ChoiceReader("ihier_part",
					List.of("_seq_ihier_part", "ipath_absolute", "ipath_rootless", "ipath_empty"), false),
			new SequenceReader("_seq_ihier_part", List.of("//", "iauthority", "ipath_abempty"),
					false, List.of(1, 2)),
			new StringReader("ipath_empty", "", false),
			new ChoiceReader("irelative_part",
					List.of("_seq_ihier_part", "ipath_absolute", "ipath_noscheme", "ipath_empty"), false),
			new StringReader("//", "//", false),
